...
print(f"""
 ...
 |_   _|__  __ _ _ __   ___ | |_ 
   ...
   |_|\\___|\\__,_| .__/ \\___/ \\__|
    by Cofrom keep_alive import keep_aliveIan |_| & RedTea
...
bot = dcmd.Bot(intents=intents, command_prefix="b.", help_command=None)
...
async def on_ready():
    ...
    bot.load_extension("teapot.cogs.cmds")
    bot.load_extension("teapot.cogs.music")
    bot.load_extension("teapot.cogs.cat")
    bot.load_extension("teapot.cogs.neko")
